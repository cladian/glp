    ...
    <section class="slide">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
            ...
            <div class="caja">
                ...
                <div class="panel-body">
                    ...
                    <?php ActiveForm::end(); ?>
                    <div>
                        <p style="text-align:center; padding-top: 0px;" class="texto-info">Al hacer clic en "Crear
                            cuenta",
                            confirma y acepta los términos de servicio, la política de privacidad de ASOCAM, así como
                            recibir comunicaciones y notificaciones desde el sistema.</p>
        ...
        <div style="text-align:justify; padding-top: 60px;"
            ...
            <div class="caja-slide">
                <h1 class="tituto-slide"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span>
                    Bienvenidos</h1>
        ...
        <div class=" hidden-xs hidden-md hidden-sm hidden-lg site-index">
            ...
            <div class="jumbotron">
                ...
                <p class="lead">Al sistema de Registro de Participantes ASOCAM, a tavés de este sistema podrá
                    registrarse y
